...
<br>
<h1 style="text-align: center">-----------------------НАЧАЛО ВЁРСТКИ ДЕТАЛЬНОЙ СТРАНИЦЫ САНАТОРИЯ-------------------------</h1>
...
<br>
<h1 style="text-align: center">-----------------------КОНЕЦ ВЁРСТКИ ДЕТАЛЬНОЙ СТРАНИЦЫ САНАТОРИЯ-------------------------</h1>

<br>
<h1 style="text-align: center">-----------------------НАЧАЛО ВЁРСТКИ КНОПКИ СЛАЙДЕРА ДЛЯ ПЕРЕХОДА КО ВСЕМ ФОТОГРАФИЯМ САНАТОРИЯ-------------------------</h1>
...
<br>
<h1 style="text-align: center">-----------------------КОНЕЦ ВЁРСТКИ КНОПКИ СЛАЙДЕРА ДЛЯ ПЕРЕХОДА КО ВСЕМ ФОТОГРАФИЯМ САНАТОРИЯ-------------------------</h1>
<br>
<h1 style="text-align: center">-----------------------НАЧАЛО ВЁРСТКИ ВСЕХ ФОТОГРАФИЙ САНАТОРИЯ (ПЛИТКА)-------------------------</h1>
    ...
    <div class="engBox-body clearfix">
        <div class="center">
            <div class="images">
                ...
                <div class="img">
                    <a href="/images/prices-feedback-bg.jpg" class="border various">
                        <img src="/images/prices-feedback-bg.jpg" alt="1 местный 1 комнатный 1 категория Целебный ключ" title="1 местный 1 комнатный 1 категория Целебный ключ">
                    </a>
                </div>
                <div class="img">
                    <a href="/upload/resize_cache/iblock/0f2/375_1000_1a0e135b89fe9395d0e82863650ebcf5b/0f216567e1b5d96a0960547e859c1197.jpg" class="border various">
...
<br>
<h1 style="text-align: center">-----------------------КОНЕЦ ВЁРСТКИ ВСЕХ ФОТОГРАФИЙ САНАТОРИЯ (ПЛИТКА)-------------------------</h1>

<br>
<h1 style="text-align: center">-----------------------НАЧАЛО ВЁРСТКИ КНОПОК САЙТА (ЗАМЕНА input и button на span или div) -------------------------</h1>
<!--НАЧАЛО ВЁРСТКИ КНОПОК САЙТА (ЗАМЕНА input и button на span или div)-->
<div class="engBox-right card-form">
    <div id="right-form">
        <form method="POST" id="formx" data-form="bron" action="javascript:void(null);">
            <div class="controlgroup mobile ui-controlgroup ui-controlgroup-horizontal ui-helper-clearfix" style="color: #505050;" role="toolbar">
                <div class="_form-check">
                    <input name="_check" type="checkbox" id="checkbox-lic" data-class="_form-check-btn" class="ui-checkboxradio ui-helper-hidden-accessible">
                    <label for="checkbox-lic" class="checkbox-tr-btn ui-button ui-widget ui-controlgroup-item ui-checkboxradio-label ui-corner-right"><span class="ui-checkboxradio-icon ui-corner-all ui-icon ui-icon-background ui-icon-blank"></span><span class="ui-checkboxradio-icon-space"> </span>
                        Я ознакомлен <a target="_blank" href="https://putevochka.com/contacts/Dogovor.compressed.pdf">c положением об обработке и защите персональных данных.</a>
                    </label>
                </div>
                <div class="_form-check-btn">


                    <!--НАЧАЛО КНОПКИ КАЛЬКУЛЯТОРА-->
        ...
        <!--НАЧАЛО КНОПКИ ОСТАВИТЬ ОТЗЫВ-->
            <span class="feedback-form-btn feedback-form-btn-span">Оставить отзыв</span>
        <!--КОНЕЦ КНОПКИ ОСТАВИТЬ ОТЗЫВ-->

        <!--НАЧАЛО КНОПКИ ЗАДАТЬ ВОПРОС-->
            <span class="feedback-form-btn feedback-form-btn-span">Задать вопрос</span>
        <!--КОНЕЦ КНОПКИ ЗАДАТЬ ВОПРОС-->

<!--КОНЕЦ ВЁРСТКИ КНОПОК САЙТА (ЗАМЕНА input и button на span или div)-->
<br><br><br><br>

<br><br><br><br>
<h1 style="text-align: center">-----------------------КОНЕЦ ВЁРСТКИ КНОПОК САЙТА (ЗАМЕНА input и button на span или div) -------------------------</h1>

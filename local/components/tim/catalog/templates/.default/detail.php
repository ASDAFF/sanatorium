...
?>
	...
	<div class="engBox-body page-card">
		<div class="engBox-center">
			<div id="content">
				<div id="content-top">Россия, Ставропольский край, г. Ессенткуки ул. Пятигорская , 44</div>
				...
				<div id="tabs" class="content-menu content-menu-buttons-box">
					...
					<div id="tabs-2">
						<div class="el-nomer">
							<div class="item">
								<div class="img">
									<a href="#bron1" class="border various">
										<img src="images/img.jpg">
									</a>
								</div>
								<div class="text">
									<a href="#bron1" class="title various">Стандартный твин</a><br>
									<b>Площадь:</b> 10 м2 <br><br>
									<b>Кровати:</b> большая двуспальная<br><br>
								...
								<div class="inf">
									...
									<a href="#bron1" class="btn various">забронировать</a>
								...
								<div id="bron1" class="okno" style="display: none">
									<div class="title">Стандартный твин</div>
									<div class="el-nomer-popap">
										<div class="left">
											...
											<div class="info-bottom">
												...
												<div class="inf">
													<div class="price-start"><span class="txt">Цена за номер в сутки от</span><span class="num">2000р</span></div>
													<i class="price-start-details">(в стоимость проживания входит лечение по общетерапевтической путевке)</i>
											...
											<div style="text-align: center">
												<input id="popup-bron-btn" type="button" class="btn-okno ui-widget ui-controlgroup-item ui-button ui-corner-right" href="" value="ЗАБРОНИРОВАТЬ" role="button">
											</div>
										</div>
						...
						<div class="programs">
							<?foreach($pr as $value):?>
								<div class="programs-item">
									<div class="programs-title"><span class="icon icon-1"></span><span><?=$value["NAME"]?></span></div>
						...
						<div class="infra-box">
							<ul class="infra-list">
								<?foreach($info as $value):?>
									<li><i class="in-icon"><img src="<?=$value['PREVIEW_PICTURE']?>"></i><span><?=$value['NAME']?></span></li>
								<?endforeach?>
							</ul>
						...
						<div class="tab-actions">
							...
							<?foreach($shares as $value):?>
								<div class="tab-actions-item">
									...
									<div class="tab-actions-time"><b>Период действия:</b> <?=$value["PROPERTY_PERIOD_VALUE"]?></div>
									<?=$value["DETAIL_TEXT"]?>
								</div>
							<?endforeach?>
		...
		<div class="engBox-right card-form">
			<div id="right-form">
				...
				<div id="bron" class="okno" style="display: none">
					...
					<p> Показания: заболевания органов пищеварения и нарушение обмена веществ (в т.ч. сахарный диабет и ожирение), заболевания опорно-двигательного аппарата, нервной системы, гинекологические и урологические заболевания</p>
					<p> Ожидаемые результаты: снятие физического и эмоционального стресса; повышение работоспособности; улучшение обмена веществ; улучшение эмоционального состояния, прилив жизненных сил.</p>
					...
					<div id="tabs2" class="content-menu" style="background: none!important;">
						...
						<input type="button" class="btn-okno various ui-widget ui-controlgroup-item ui-button ui-corner-right" href="#bron" value="ЗАБРОНИРОВАТЬ" role="button">
					</div>
				</div>
			</div>
		</div>

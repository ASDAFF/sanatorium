...
<div class="engBox-body">
    <div class="engText">
        <div class="it-title">Лечение в санаториях КМВ – это не только вклад в здоровье, но и приятные воспоминания!</div>
        <p>Поездка «на воды» уже давно стал хорошо себя зарекомендовавшим трендом. Со времен открытия первых целебных источников в начале ХIХ века и сегодня – города-курорты стабильно развивают свою инфраструктуру и улучшают туристический сервис. Ежегодно регион КМВ принимает гостей не только из других городов нашей страны, но и из разных стран мира. Здравницы Пятигорска, Железноводска, Ессентуков и Кисловодска – это учреждения с 200-летней историей, признанные лидеры в сфере санаторно-курортного лечения России.</p>
        <p>Экологически чистый регион КМВ объединяет культуру и традиции десятков народов, в каждом городе-курорте свои особенности и все санатории по-своему уникальны. Даже основываясь на своих показаниях к лечению и бюджете, вам придется сделать выбор из двух-трех десятков мест. Именно для того, чтобы облегчить эту непростую задачу мы создали сервис бесплатного бронирования «Путёвочка». Быстрый поиск для бронирования мест в санаториях по многочисленным параметрам, качественные фотографии интерьеров, бесплатные консультации по всем интересующим вас вопросам – то, что поможет вам провести время с пользой для здоровья и получить массу положительных впечатлений.</p>
    </div>
</div>
<?

...
?>
<div class="engBox-right card-form new-form" style="margin-bottom: 30px;">
	<form class="calculator" id="price-form-tab">
		<input type="hidden" name="san" value="<?= $product['ID'] ?>" />
		<div class="form-title">
			<span class="form-title-first">Заполните форму</span>
			<span class="form-title-second">чтобы забронировать номер</span>
		</div>
		<div class="form-body">
			<div class="calendar">

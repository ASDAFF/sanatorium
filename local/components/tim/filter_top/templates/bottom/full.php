                        ...
                        <? foreach ($filter['GROUPS'] as $group) {
                            if ($group['TYPE'] == 'price') {
                                ...
                                <div style="display: none" class="price-group"<?= $style ?>
                                     ...
                                     data-max="<?= $group['MAX'] ?>">
                                    <div class="inputs">
                                        <div class="l">от <input type="text" class="from" value="<?= $group['MIN'] ?>"/>
                                        </div>
                                        <div class="r">до <input type="text" class="to" value="<?= $group['MAX'] ?>"/>
                                        </div>
                                    </div>
                                </div>
                                <span id="slider-range-value01"><?= $group['MIN'] ?></span>
                                <div id="slider-range-d" class='slider-range'></div>
                                <span id="slider-range-value02"><?= $group['MAX'] ?></span>
                            <? }
                        } ?>
                    </div>
